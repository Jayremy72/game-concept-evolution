...
const Index = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-b from-blue-50 to-green-50 dark:from-blue-950 dark:to-green-950">
      <header className="py-3 px-4 bg-white dark:bg-gray-900 shadow-md">
      ...
      <footer className="py-2 px-4 bg-white dark:bg-gray-900 text-center text-xs text-gray-500 dark:text-gray-400">
